...
Validation: existing purchase delivery helper regressions, TypeScript checking, focused lint on the new component/API and `git diff --check` pass. Deployment is not part of this change; production remains on web155 until a web release is authorized.
