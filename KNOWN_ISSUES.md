...
September 14 sourcing exhausted its swap-headroom preflight; September 15 exhausted disk headroom. Authorized September 15 remediation expanded disk from 8 GB to 32 GB and compute from Small (2 GB RAM) to Medium (4 GB). Both capacity blockers cleared: 24.58 GiB disk free, 3.16 GiB RAM available, 100% swap free, PostgreSQL up and tiny read successful at 19:03:09 UTC. One authorized sourcing rerun (`33f583b3-41bf-4f26-bea5-0fc2b2e81877`) passed its unchanged production gate and started Daily catalog sourcing; the full run subsequently completed successfully at 21:10:05 UTC, with all five stages successful. See [upgrade and run evidence](docs/supabase_capacity.md) and [original failure evidence](docs/purchase_metrics_sourcing_fixes_2026-09-15.md). Across 125 run samples, available RAM stayed above 1.459 GiB and swap above 99.9977% free, with no OOM or capacity waits. [Completed run review](docs/sourcing_medium_run_review_2026-09-15.md).
...
## Phase 3 ground truth insufficient — 2026-09-13

The prior 417-row “strict receiving” label overstated provenance: UI/API default correct_item, and the intelligence builder calls any ASIN-assigned purchase verified. The [reconciliation](docs/sourcing_positive_evidence_reconciliation_2026-09-13.md) records zero qualifying Tier A pairs, 26 unresolved receiving assertions, four current ASIN discrepancies, demonstrated field defects and a 16-row manual-review queue. No activation, refresh or deployment is authorized by this audit. Phase 3 remains shadow-only; atomic refresh protection and authenticated production UI verification remain outstanding.
