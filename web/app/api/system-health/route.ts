...
const SCHEDULER_GROUPS: SchedulerGroupConfig[] = [
  ...
  {
    key: "amazon-return-recovery",
    label: "Amazon Return Recovery",
    domain: "Loss Prevention",
    cadence: "Daily afternoon",
    schedule: "3:45 PM PT",
    scheduleNames: ["mbop-amazon-return-recovery-daily"],
    expectedEveryHours: 24,
    criticalAfterHours: 36,
    description: "Refreshes Amazon FBA customer return rows and reimbursement evidence for the Return Recovery queue.",
    features: ["Amazon Returns", "Return Recovery", "Reimbursement review"],
    jobNames: ["Amazon FBA customer returns report", "Amazon FBA reimbursements report"],
  },
  {
    key: "reconciliation",
  ...
  },
  {
    ...
    domain: "Sourcing",
    cadence: "Daily after eBay quota reset",
    schedule: "12:10 AM PT",
    scheduleNames: ["mbop-sourcing-catalog"],
    expectedEveryHours: 24,
    criticalAfterHours: 36,
    description: "Refreshes daily catalog sourcing, Browse and Trading listing availability, and matching intelligence.",
    features: ["Sourcing workspace", "Matching intelligence", "Purchase matching"],
    jobNames: [
      "Daily catalog sourcing",
      "Sourcing listing availability",
      "Sourcing listing availability Trading fallback",
